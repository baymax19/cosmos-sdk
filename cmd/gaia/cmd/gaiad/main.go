...
// gaiad custom flags
const flagInvariantsChecksFrequency = "inv-checks-freq"

var invariantsChecksFrequency uint
...
func main() {
	...
	rootCmd.PersistentFlags().UintVar(&invariantsChecksFrequency, flagInvariantsChecksFrequency,
...
func newApp(logger log.Logger, db dbm.DB, traceStore io.Writer) abci.Application {
	return app.NewGaiaApp(
		logger, db, traceStore, true, invariantsChecksFrequency,
